...
namespace NewAgeLauncher
{
    public partial class SettingsForm : Form
    {
        ...
        private void SettingsForm_Load(object sender, EventArgs e)
        {
            ...
            Language_Checkbox.Checked = Settings_ES.Default.LanguageChangeTag;
            Font_Checkbox.Checked = Settings_ES.Default.FontAdditionTag;
        }
        ...
        private void save_button_Click(object sender, EventArgs e)
        {
            ...
            Settings_ES.Default.WowLocation = wowLocationTextBox.Text;

            // Transparency Checkbox

            if (Transparent_Checkbox.Checked == true)
            {
                Settings_ES.Default.TransparencyToggle = true;
            }
            if (Transparent_Checkbox.Checked == false)
            {
                Settings_ES.Default.TransparencyToggle = false;
            }
            ...
            {
                Settings_ES.Default.WoWCacheToggle = true;
            }
            else
            {
                Settings_ES.Default.WoWCacheToggle = false;
            }
            ...
            {
                Settings_ES.Default.LanguageChangeTag = true;
            }
            else
            {
            ...
            {
                Settings_ES.Default.FontAdditionTag = true;
            }
            else
            {
                Settings_ES.Default.FontAdditionTag = false;
            }
            ...
            if (Settings_ES.Default.FontAdditionTag == true)
            {
